...
{
    internal static class MapToAttributeSource
    {
        internal const string AttributeName = "MapTo";
        ...
        internal static SourceCode Generate(SourceGenerationOptions options)
        {
            ...
            if (options.GenerateXmlDocument)
            {
                builder
                    ...
                    .WriteLine("/// </summary>")
                    .WriteLine("/// <param name=\"sourceType\">The type of to map to.</param>");
            }
            ...
            if (options.GenerateXmlDocument)
            {
                builder
                    .WriteLine("/// <summary>")
                    .WriteLine("/// Gets the type to map to.")
                    .WriteLine("/// </summary>");
            }
